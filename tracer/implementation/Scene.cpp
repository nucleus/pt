...
void tracer::Scene::read() {
	...
	m_objects.push_back( 
		new geometry::Sphere(glm::vec3(0.0f, 4.0f, 0.0f), 0.8f, material::Material(glm::vec3(0.0f), glm::vec3(2.0f, 2.0f, 2.0f))) ); // light
	m_objects.push_back(
		new geometry::Sphere(glm::vec3(0.6f, 0.61f, -0.1f), 0.6f, material::Material(glm::vec3(0.25f, 0.75f, 0.25f))) ); // sphere 1
	m_objects.push_back( 
		new geometry::Sphere(glm::vec3(-0.6f, 0.51f, 0.8f), 0.5f, material::Material(glm::vec3(0.999f, 0.999f, 0.999f), glm::vec3(0.0f), material::Material::Type_reflective)) ); // sphere 2
}
